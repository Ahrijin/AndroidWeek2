...
public class RecycleQuanAdapter extends RecyclerView.Adapter<RecycleQuanAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder,final int i) {
        ...
        Log.e("状态", "onBindViewHolder: "+whetherGreat);
        if(whetherGreat == 1){
            circleList.get(i).setCheck(true);
        }else if(whetherGreat == 2){
            circleList.get(i).setCheck(false);
        }
        //将点赞状态赋给控件
        viewHolder.imgs3.setChecked(circleList.get(i).isCheck());
